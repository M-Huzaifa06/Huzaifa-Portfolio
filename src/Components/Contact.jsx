    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          {/* Badge */}
          <div className="inline-block text-xs sm:text-sm font-semibold tracking-widest uppercase 
                          px-6 py-2 rounded-full 
                          bg-gradient-to-r from-indigo-400 to-purple-500 mb-6">
            Get In Touch
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.05 0C5.495 0 .16 5.335.157 
...
function ContactCard({ title, text, link, children, delay }) {
  return (
    <div
      className="bg-[#111118] border border-white/5 rounded-xl 
    ...
    >
      ...
      <a
        ...
        className="text-xs sm:text-sm text-gray-400 hover:text-indigo-400 transition `break-words`"
      >
        {text}
      </a>
    </div>
